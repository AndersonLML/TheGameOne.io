 ...
 - this.height;        }
    ...
    function displayStatusText(context){
        ...
        if (gameOver){
            ...
            context.fillStyle = 'black';
            context.fillText('GAME OVER, pressione Enter ou deslize para baixo para reiniciar!', canvas.width/2, 200);
            context.fillStyle = 'white';
            context.fillText('GAME OVER, pressione Enter ou deslize para baixo para reiniciar!', canvas.width/2 +2, 202);
        }
    }
        ...
        function toggleFullScreen(){
            ...
            if(!document.fullscreenElement){
                canvas.requestFullscreen().catch(err => {
                    alert(`Erro, tela cheia não ativada: ${err.message}`);
                });
            } else {
